 ...
 *
 * Copyright (C) 2018, Oguzhan Eroglu <rohanrhu2@gmail.com>
 * Licensed under MIT
 */
...
var NodesJs = (function (parameters) {
    ...
    t_NodesJs.particleSize = parameters.particleSize ? parameters.particleSize: 3;
    ...
    t_NodesJs.number = parameters.number ? parameters.number: 1000;
    t_NodesJs.speed = parameters.speed ? parameters.speed: 20;
    t_NodesJs.nobg = parameters.nobg ? parameters.nobg: false;
    t_NodesJs.pointerCircleRadius = parameters.pointerCircleRadius ? parameters.pointerCircleRadius: 20;
