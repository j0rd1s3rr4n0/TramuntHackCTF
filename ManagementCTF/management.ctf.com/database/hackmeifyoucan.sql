...
INSERT INTO machines (id, name, ip_address, os, description, points, user_flag, root_flag, hint1, hint2, hint3) VALUES
	(1, 'HackMeIfYouCan', '172.16.0.2', 'Linux', 'Could you audit my first personal page? I will give you all my points if you become an administrator.', 100, 'CTF{user_flag_hackme}', 'CTF{root_flag_hackme}', 'Intenta acceder como usuario.', 'Busca archivos con permisos inusuales.', 'Revisa los servicios que están corriendo.');
