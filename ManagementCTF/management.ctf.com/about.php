                ...
                <div class="col-xl-12">
                    ...
                    <div class="row justify-content-center hackerFont">
                        <div class="col-md-8">
                            ...
                            <h5 class="bold color_white pt-3">
                                About TRAMUNTHACKCTF
                            </h5>
                            <h5 class="bold color_white pt-3">
                                Who can play TRAMUNTHACKCTF
                            </h5>
                            TRAMUNTHACKCTF is mainly focused at students who are undergraduates.
                            <div class="row text-center pt-5">
                                <div class="col-xl-12">
                                    <button class="btn btn-outline-danger btn-shadow px-3my-2 ml-0 ml-sm-1 text-left typewriter" onclick="(function(){window.location.href='login.php'})();">
                                        <h4>LET IT RIP!</h4>
                                    </button>
                                </div>
                            </div>
